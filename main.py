...
def displayForeCast():
  img = "https://source.unsplash.com/random/1600x900/?"+cityName
  url = "https://pro.openweathermap.org/data/2.5/forecast/climate?q={}&units=imperial&cnt={}&appid={}".format(cityName,days,weatherApiKey)
  form = City()
  try:
    r = requests.get(url)
    data = r.json()
  ...
  return render_template('forecast.html', data=data,img=img,form=form,week=week,weekdays=weekdays)
